...
module dhcp (
  ...
  //axis in
  input 				  dhcp_rx_tvalid,
  output 			  dhcp_rx_tready,
  input 		 [ 7:0] dhcp_rx_tdata,
  input   		     dhcp_rx_tlast,
  //axis out
  output 			  dhcp_tx_tvalid,
  input  			  dhcp_tx_tready,
  output		 [ 7:0] dhcp_tx_tdata,
  output   		     dhcp_tx_tlast
);
          ...
          if (byte_no < length) begin
            if (udp_tx_active) begin
              case (byte_no)
                ...
                16: tx_data <= 8'd0;    // 12 zeros YIADDR, SIADDR & GIADDR zero 8octet zero
                ...
                236: tx_data <= 8'h63; //ma-
                237: tx_data <= 8'h82; //-gic-
                238: tx_data <= 8'h53; //-coo-
                239: tx_data <= 8'h63; //-kie
                240: tx_data <= 8'h35;
                241: tx_data <= 8'h01;
